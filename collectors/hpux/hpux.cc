...
void HPUXPerfData::getStaticCPUData() throw(RunQError)
{
...
void HPUXPerfData::getStaticMemoryData() throw(RunQError)
{
...
void HPUXPerfData::getDynamicMemoryData() throw(RunQError)
{
  struct pst_dynamic psd;
...
void HPUXPerfData::getStaticIOData() throw(RunQError)
{
...
void HPUXPerfData::getDynamicCPUData() throw(RunQError)
{
  int Counter;
  struct pst_dynamic psd;
...
void HPUXPerfData::getDynamicIOData() throw(RunQError)
{
  dynamicData.IO.bytesRead = 0;
  dynamicData.IO.bytesWritten = 0;
}
...
void HPUXPerfData::sample(const bool fullSample) throw(RunQError)
{
  getProcesssesData();
  if (fullSample)
    {
...
void HPUXPerfData::getProcesssesData() throw(RunQError)
{
  int NrOfProcesses;
  int Index;
  int i;
...
void HPUXPerfData::getUsersData() throw(RunQError)
{
...
void HPUXPerfData::getGroupsData() throw(RunQError)
{
