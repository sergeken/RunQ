...
void OpenBSDPerfData::sample(bool lastSample) throw(RunQError)
{
	getProcessList();
	if (lastSample)
	{
...
void OpenBSDPerfData::getDynamicCPUData() throw(RunQError)
{
}


void OpenBSDPerfData::getDynamicIOData() throw(RunQError)
{
}

void OpenBSDPerfData::getDynamicMemoryData() throw(RunQError)
{
}

void OpenBSDPerfData::getProcessData(long PID) throw(RunQError)
{
...
void OpenBSDPerfData::getProcessList() throw(RunQError)
{
...
void OpenBSDPerfData::getStaticCPUData() throw(RunQError)
{
}


void OpenBSDPerfData::getStaticMemoryData() throw(RunQError)
{
}


void OpenBSDPerfData::getStaticNetworkData() throw(RunQError)
{
}


void OpenBSDPerfData::getStaticIOData() throw(RunQError)
{
}

void OpenBSDPerfData::getUsersData() throw(RunQError)
{
...
void OpenBSDPerfData::getGroupsData() throw(RunQError)
{
