...
void SolarisPerfData::getStaticCPUData() throw(RunQError)
{
    kstat_t *ks;
    kid_t kcid;
    cpu_stat_t cpu_stat;
...
void SolarisPerfData::getStaticMemoryData() throw(RunQError)
{
    kstat_t *ks;
    kid_t kcid;
    kstat_named_t * kn;
...
void SolarisPerfData::getDynamicMemoryData() throw(RunQError)
{
    kstat_t *ks;
    kid_t kcid;
    kstat_named_t * kn;
...
void SolarisPerfData::getStaticIOData() throw(RunQError)
{
...
void SolarisPerfData::getDynamicCPUData() throw(RunQError)
{
    kstat_t *ks;
    kid_t kcid;
    cpu_stat_t cpu_stat;
...
void SolarisPerfData::getDynamicIOData() throw(RunQError)
{
    kstat_t *ks;
    kid_t kcid;
    kstat_io io_stat;
...
void SolarisPerfData::sample(const bool fullSample) throw(RunQError)
{
    if (fullSample)
    {
	kid_t kcid;
...
void SolarisPerfData::getProcesssData(const long PID) throw(RunQError)
{
...
void SolarisPerfData::getProcesssesData() throw(RunQError)
{
...
void SolarisPerfData::getUsersData() throw(RunQError)
{
...
void SolarisPerfData::getGroupsData() throw(RunQError)
{
