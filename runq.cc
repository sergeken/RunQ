...
void report(int argc, char *argv[])
{
	...
	for (;;) 
	{
	    ...
	    if (beforeTime((time_t*)&perfData.dynamicData.timeStamp,
	    ...
	    else if ( ! beforeTime((time_t*)&perfData.dynamicData.timeStamp,
			endHour, endMinute))
	    {
		break;
	    }
...
void report_procs(int argc, char *argv[])
{
    int option;
    char const * dataFile = "perf.dat";
    char * startTime = 0;
    ...
    if (dateFormat)
	cout << "Date;Time;PID;PPID;Name;Args;User;Group;utime;stime;wtime;sleeptime;cutime;cstime;cwtime;csleeptime;MinFLT;MajFlt;cMinFlt;CMajFlt;inbytes;oubytes;RSS" << endl;
    else
	cout << "RECORD;TimeStamp;PID;PPID;Name;Args;User;Group;utime;stime;wtime;sleeptime;cutime;cstime;cwtime;csleeptime;MinFLT;MajFlt;cMinFlt;CMajFlt;inbytes;oubytes;RSS" << endl;
